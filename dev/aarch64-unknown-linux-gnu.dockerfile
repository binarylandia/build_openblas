...
RUN set -euxo pipefail >/dev/null \
&& mkdir -p "${GCC_DIR}" \
&& curl -fsSL "https://github.com/binarylandia/build_crosstool-ng/releases/download/2024-10-30_09-44-58/gcc-9.5.0-aarch64-unknown-linux-gnu-2024-10-30_09-44-58.tar.xz" | tar -C "${GCC_DIR}" -xJ \
